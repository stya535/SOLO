...
import youtube_dl
#=============
cl = LineClient(authToken='EysQNmKVr6zazWioUGhb.Tx62nM7oktyj0XmmGnMdIW.dafpjzizTPQLZpsAD+K4WdVQkl+7zymksdig9xulClU=')
...
poll = LinePoll(cl)
call = cl
creator = ["ub57eb6366ece293609d3130c80d9838b"]
owner = ["ub57eb6366ece293609d3130c80d9838b"]
admin = ["ub57eb6366ece293609d3130c80d9838b"]
staff = ["ub57eb6366ece293609d3130c80d9838b"]
mid = cl.getProfile().mid
KAC = [cl]
ABC = []
Bots = [mid]
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Nahh loo keciduk kan... Gabung sini akak biar rame 😃😃😊",
    "Respontag":"Apaan sih tag2.....! Kangen ya...😃😃😃😃",
...
#===========Protection============#
                        ...
                        elif 'Protectkicdsk ' in msg.text:
                           if msg._from in admin:
                        ...
                        elif 'Protectjoissn ' in msg.text:
                           if msg._from in admin:
                        ...
                        elif 'Protectcrrancel ' in msg.text:
                           if msg._from in admin:
...
#===========ADMIN ADD============#
                        ...
                        elif cmd == "admin:obbn" or text.lower() == 'admin:on':
                            if msg._from in admin:
                                wait["addadmin"] = True
                                cl.sendText(msg.to,"Kirim kontaknya...")

                        elif cmd == "admin:repbbeat" or text.lower() == 'admin:repeat':
                            if msg._from in admin:
                                wait["delladmin"] = True
                                cl.sendText(msg.to,"Kirim kontaknya...")

                        elif cmd == "stafnnf:on" or text.lower() == 'staff:on':
                            if msg._from in admin:
                                wait["addstaff"] = True
                                cl.sendText(msg.to,"Kirim kontaknya...")

                        elif cmd == "staff:nnrepeat" or text.lower() == 'staff:repeat':
                            if msg._from in admin:
                                wait["dellstaff"] = True
                                cl.sendText(msg.to,"Kirim kontaknya...")

                        elif cmd == "bot:ohhn" or text.lower() == 'bot:on':
                            if msg._from in admin:
                                wait["addbots"] = True
                                cl.sendText(msg.to,"Kirim kontaknya...")

                        elif cmd == "bot:repgggeat" or text.lower() == 'bot:repeat':
                            if msg._from in admin:
                                wait["dellbots"] = True
                                cl.sendText(msg.to,"Kirim kontaknya...")
