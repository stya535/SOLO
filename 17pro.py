...
channel11 = LineChannel(kx)
kx.log("Channel Access Token : " + str(channel11.channelAccessToken))
lineProfile = kx.getProfile()
lineSettings = kx.getSettings()
Kmid = kx.getProfile().mid
responsename12 = kx.getProfile().displayName

kz = LineClient("","")
kz.log("Auth Token : " + str(kz.authToken))
channel12 = LineChannel(kz)
kz.log("Channel Access Token : " + str(channel12.channelAccessToken))
lineProfile = kz.getProfile()
lineSettings = kz.getSettings()
Lmid = kz.getProfile().mid
responsename13 = kz.getProfile().displayName

k1 = LineClient("","")
k1.log("Auth Token : " + str(k1.authToken))
channel13 = LineChannel(k1)
k1.log("Channel Access Token : " + str(channel13.channelAccessToken))
lineProfile = k1.getProfile()
lineSettings = k1.getSettings()
Mmid = k1.getProfile().mid
responsename14 = k1.getProfile().displayName

k2 = LineClient("","")
k2.log("Auth Token : " + str(k2.authToken))
channel14 = LineChannel(k2)
k2.log("Channel Access Token : " + str(channel14.channelAccessToken))
lineProfile = k2.getProfile()
lineSettings = k2.getSettings()
Nmid = k2.getProfile().mid
responsename15 = k2.getProfile().displayName

aj = LineClient("","")
aj.log("Auth Token : " + str(aj.authToken))
channel15 = LineChannel(aj)
aj.log("Channel Access Token : " + str(channel15.channelAccessToken))
lineProfile = aj.getProfile()
lineSettings = aj.getSettings()
Xmid = aj.getProfile().mid
responsename16 = aj.getProfile().displayName

sw = LineClient("","")
sw.log("Auth Token : " + str(sw.authToken))
channel16 = LineChannel(sw)
sw.log("Channel Access Token : " + str(channel16.channelAccessToken))
lineProfile = sw.getProfile()
lineSettings = sw.getSettings()
Zmid = sw.getProfile().mid
responsename17 = sw.getProfile().displayName
...
Xmid = aj.getProfile().mid
Zmid = sw.getProfile().mid
KAC = [cl,ki,kk,kc,km,kb,kn,ko,kw,ke,ky,kx,kz,k1,k2]
ABC = [ki,kk,kc,km,kb,kn,ko,kw,ke,ky,kx,kz,k1,k2]
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid,Mmid,Nmid,Xmid,Zmid]
Dpk = admin + staff
...
responsename11 = kx.getProfile().displayName
responsename12 = kz.getProfile().displayName
responsename13 = k1.getProfile().displayName
responsename14 = k2.getProfile().displayName
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            group = kx.getGroup(op.param1)
                                            gMembMids = [contact.mid for contact in group.invitee]
                                            for _mid in gMembMids:
                                                kx.cancelGroupInvitation(op.param1,[_mid])
                ...
                if op.param1 in protectantijs:
                  if op.param3 in mid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        aj.kickoutFromGroup(op.param1,[op.param2])
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                Setmain["ARfoto"][Cmid] = True
                                kx.sendText(msg.to,"Kirim fotonya.....")
                                
                        elif cmd == "bot12up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Zmid] = True
                                kz.sendText(msg.to,"Kirim fotonya.....")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kx.sendMessage(msg.to,responsename11)
                                kz.sendMessage(msg.to,responsename12)
                                k1.sendMessage(msg.to,responsename13)
                                k2.sendMessage(msg.to,responsename14)
                           ...
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
                                      ...
                                      kx.sendMessage(midd, str(Setmain["ARmessage1"]))
                                      kz.sendMessage(midd, str(Setmain["ARmessage1"]))
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     group11 = kx.findGroupByTicket(ticket_id)
                                     kx.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kx.sendMessage(msg.to, "Masuk : %s" % str(group.name))
                                     group12 = kz.findGroupByTicket(ticket_id)
                                     kz.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kz.sendMessage(msg.to, "Masuk : %s" % str(group.name))
                                     group12 = k1.findGroupByTicket(ticket_id)
                                     k1.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     k1.sendMessage(msg.to, "Masuk : %s" % str(group.name))
                                     group13 = k2.findGroupByTicket(ticket_id)
